...
class NsFavoriteProduct extends ObjectModel
{
	public $id;
	...
	public static $definition = array(
		'table' => 'ns_favorite_product',
		'primary' => 'id_ns_favorite_product',
		'fields' => array(
	...
	public static function getFavoriteProducts($id_customer, $id_lang)
	{
		return Db::getInstance(_PS_USE_SQL_SLAVE_)->executeS('
			...
			FROM `'._DB_PREFIX_.'ns_favorite_product` fp
	...
	public static function getFavoriteProduct($id_customer, $id_product, Shop $shop = null)
	{
		...
		$id_favorite_product = Db::getInstance(_PS_USE_SQL_SLAVE_)->getValue('
			SELECT `id_ns_favorite_product`
			FROM `'._DB_PREFIX_.'ns_favorite_product`
		...
		if ($id_favorite_product)
			return new NsFavoriteProduct($id_favorite_product);
		return null;
	}
