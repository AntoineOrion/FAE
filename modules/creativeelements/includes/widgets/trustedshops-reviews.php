...
class WidgetTrustedShopsReviews extends WidgetBase
{
    ...
    protected function _registerControls()
    {
        ...
        $this->addControl(
            ...
            array(
                ...
                'options' => array(
                    ...
                    '2' => __('Show form 2 Stars', 'elementor'),
                    '3' => __('Show form 3 Stars', 'elementor'),
                    '4' => __('Show form 4 Stars', 'elementor'),
                    '5' => __('Show form 5 Stars', 'elementor'),
                ),
            )
        );
        ...
        $this->addResponsiveControl(
            'slides_to_show',
            array(
                'label' => __('Reviews to Show', 'elementor'),
                'type' => ControlsManager::SELECT,
                'default' => '',
                'options' => array(
        ...
        $this->addControl(
            'slides_to_scroll',
            array(
                'label' => __('Reviews to Scroll', 'elementor'),
                'type' => ControlsManager::SELECT,
                'default' => '2',
