...
class WidgetAjaxSearch extends WidgetBase
{
    ...
    protected function render()
    {
        ...
        if (method_exists($ctx->controller, 'registerJavascript')) {
            $ctx->controller->addJqueryUI('ui.autocomplete');
            $ctx->controller->registerJavascript('ce-ajax-search', \CreativeElements::VIEWS . 'js/widgets/ajax-search.js', array('position' => 'bottom'));
        } else {
            $ctx->controller->addJqueryPlugin('autocomplete');
            $ctx->controller->addJs(__PS_BASE_URI__ . \CreativeElements::VIEWS . 'js/widgets/ajax-search.js');
        }
        ...
        ?>
        <form class="elementor-ajax-search" role="search" action="<?php echo $ctx->link->getPageLink('search') ?>" method="get">
