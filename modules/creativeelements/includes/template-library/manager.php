...
use CreativeElements\TemplateLibrary\Classes\ImportImages;
...
class Manager
{
    ...
    public function saveTemplate(array $args)
    {
        ...
        if (\CreativeElements\is_wp_error($validate_args)) {
        ...
        if (\CreativeElements\is_wp_error($template_id)) {
            return $template_id;
        }
    ...
    public function updateTemplate(array $template_data)
    {
        ...
        if (\CreativeElements\is_wp_error($update)) {
            return $update;
        }
    ...
    public function handleAjaxRequest($ajax_request)
    {
        ...
        if (\CreativeElements\is_wp_error($result)) {
        ...
        if ('ajax' === $request_type) {
            \CreativeElements\wp_send_json_success($result);
        }
