...
class CreativePage extends ObjectModel
{
    ...
    public static function getHooks()
    {
        ...
        foreach ($rows as &$row) {
            ...
            if ($hook && $hook != 'cms' && $hook != 'category' && $hook != 'tpl' && $hook != 'ybc_blog_post_class') {
                $hooks[] = $hook;
            }
        }
    ...
    public static function getGeneralPositions()
    {
        ...
        $pos[] = array('id' => 'displayTop');
        $pos[] = array('id' => 'displayBanner');
        if ($ps17) {
            $pos[] = array('id' => 'displayNav1');
            $pos[] = array('id' => 'displayNav2');
            $pos[] = array('id' => 'displayNavFullWidth');
            $pos[] = array('id' => 'displayWrapperTop');
            $pos[] = array('id' => 'displayContentWrapperTop');
        }
        $pos[] = array('id' => 'displayTopColumn');
        $pos[] = array('id' => 'displayLeftColumn');
        $pos[] = array('id' => 'displayRightColumn');
        if ($ps17) {
            $pos[] = array('id' => 'displayContentWrapperBottom');
            $pos[] = array('id' => 'displayWrapperBottom');
            $pos[] = array('id' => 'displayFooterBefore');
        }
        $pos[] = array('id' => 'displayFooter');
        if ($ps17) {
            $pos[] = array('id' => 'displayFooterAfter');
            $pos[] = array('id' => 'displayAfterBodyOpeningTag');
            $pos[] = array('id' => 'displayBeforeBodyClosingTag');
        }
        return $pos;
    }
}
