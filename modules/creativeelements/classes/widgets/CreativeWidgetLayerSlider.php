...
class CreativeWidgetLayerSlider
{
    ...
    {
        $this->name = CreativeElements\__('Creative Slider', 'elementor');
    ...
    {
        $options = array('' => CreativeElements\__('-- Select Slider --', 'elementor'));
        ...
        return array(
            ...
            'slider' => array(
                'label' => CreativeElements\__('Slider', 'elementor'),
                'type' => 'select',
                'default' => 0,
