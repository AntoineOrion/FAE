...
document.addEventListener('DOMContentLoaded', function() {
	...
	$('.btn[id$=_form_cancel_btn]')
		.removeAttr('onclick')
		.attr('href', location.href.replace(/&(id\w*=\d+&update|add)[a-z]+/, ''))
	;
	...
	if (~creativePageType.indexOf('Product')) {
		...
		$('textarea[name^=content_], textarea[name^=description_], textarea[name*="[content]"], textarea[name*="[description]"]').each(function(i, el) {
